...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('Admin/info')}}">首页</a> &raquo; 添加部门
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    <form action="{{url('Admin/Dept')}}" method="post">
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            <tr>
            ...
            <tr>
                <th>描述：</th>
                <td>
                    <textarea name="dept_read"></textarea>
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>排序：</th>
                <td>
                    <input type="text" class="sm" name="dept_sort">
                </td>
            </tr>
            <tr>
                <th></th>
